        ...
        <div className="space-y-4">
          ...
          {post.featuredImage ? (
            <Link
              ...
              target="_blank"
            >
              <div className="relative w-full h-48 rounded-lg overflow-hidden bg-slate-800/50">
                <Image
                  ...
                  unoptimized={post.featuredImage?.includes("imagekit.io")}
                />
              </div>
            </Link>
          ) : (
            <div className="relative w-full h-48 rounded-lg overflow-hidden bg-gradient-to-br from-purple-600/20 to-blue-600/20 flex items-center justify-center">
