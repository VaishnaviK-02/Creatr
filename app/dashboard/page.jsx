...
export default function DashboardPage() {
  ...
  // Fetch real data
  const { data: analytics, isLoading: analyticsLoading, error: analyticsError } = useConvexQuery(
    api.dashboard.getAnalytics
  );
  const { data: recentPosts, isLoading: postsLoading, error: postsError } = useConvexQuery(
    api.dashboard.getPostsWithAnalytics,
    { limit: 5 }
  );
  const { data: recentActivity, isLoading: activityLoading, error: activityError } = useConvexQuery(
    api.dashboard.getRecentActivity,
    { limit: 8 }
  );
  const { data: dailyViewsData, isLoading: chartLoading, error: chartError } = useConvexQuery(
  ...
  // Handle errors gracefully - use empty arrays/objects if queries fail
  const safeRecentPosts = recentPosts || [];
  const safeRecentActivity = recentActivity || [];
  const safeDailyViewsData = dailyViewsData || [];
        ...
        <div className="lg:col-span-2 space-y-6">
          <Card className="card-glass">
            ...
            <CardContent>
              ...
              ) : !safeRecentPosts || safeRecentPosts.length === 0 ? (
          ...
          <Card className="card-glass">
            ...
            <CardContent>
              <DailyViewsChart data={safeDailyViewsData} isLoading={chartLoading} />
            </CardContent>
          </Card>
        </div>
        ...
        <div className="space-y-6">
          <Card className="card-glass">
            ...
            <CardContent>
              ...
              ) : !safeRecentActivity || safeRecentActivity.length === 0 ? (
                <div className="text-center py-8">
